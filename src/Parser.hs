...
-- evalStringImpl :: Env ->  String -> String
-- evalStringImpl env expr = extractValue $ readIORef $ trapError (liftM show $ (liftThrows $ readExpr expr >>= eval env))
-- evalStringImpl env expr = runIOThrows $ liftM show $ (liftThrows $ readExpr expr) >>= eval env

evalString :: Env -> String -> IO String
-- evalString env expr = return $ evalStringImpl env expr
